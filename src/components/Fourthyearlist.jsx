...
import students4 from "../students4.json";
import Header from "./Header";
import { db } from "../firebase";
import { setDoc, doc } from "firebase/firestore";
import { useState } from "react";

const Fourthyearlist = (props) => {
  ...
  today = dd + "-" + mm + "-" + yyyy;
  const addFourthAttendance = async () => {
    await setDoc(doc(db, "Fourth year", today), {
      id: today,
